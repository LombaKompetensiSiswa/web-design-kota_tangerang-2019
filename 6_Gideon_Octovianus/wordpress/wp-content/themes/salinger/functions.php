...
function salinger_setup() {
	 ...
	 */
	add_editor_style( array( 'css/editor-style.css', salinger_get_font_url() ) );
	...
	$theme_color = get_theme_mod( 'salinger_theme_color', '#DD4040' );

	add_theme_support( 'editor-color-palette', array(
		array(
			'name'  => __( 'Theme color', 'salinger' ),
			'slug'  => 'theme-color',
			'color' => $theme_color,
		),
		array(
			'name'  => __( 'Dark gray', 'salinger' ),
			'slug'  => 'dark-gray',
			'color' => '#333',
		),
		array(
			'name'  => __( 'Medium gray', 'salinger' ),
			'slug'  => 'medium-gray',
			'color' => '#999',
		),
		array(
			'name'  => __( 'Light gray', 'salinger' ),
			'slug'  => 'light-gray',
			'color' => '#f2f2f2',
		),
		array(
			'name'  => __( 'White', 'salinger' ),
			'slug'  => 'white',
			'color' => '#fff',
		),
	) );
	...
	add_theme_support( 'editor-font-sizes', array(
		array(
			'name'      => __( 'Small', 'salinger' ),
			'shortName' => __( 'S', 'salinger' ),
			'size'      => 12,
			'slug'      => 'small',
		),
		array(
			'name'      => __( 'Normal', 'salinger' ),
			'shortName' => __( 'M', 'salinger' ),
			'size'      => 16,
			'slug'      => 'normal',
		),
		array(
			'name'      => __( 'Large', 'salinger' ),
			'shortName' => __( 'L', 'salinger' ),
			'size'      => 20,
			'slug'      => 'large',
		),
		array(
			'name'      => __( 'Huge', 'salinger' ),
			'shortName' => __( 'XL', 'salinger' ),
			'size'      => 24,
			'slug'      => 'huge',
		),
	) );
...
function salinger_scripts_styles() {
	...
	wp_enqueue_style( 'salinger-block-style', get_template_directory_uri() . '/css/blocks.css', '', SALINGER_VERSION );
 ...
 */
function salinger_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'salinger-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css' );
	// Add custom fonts.
	wp_enqueue_style( 'salinger-block-editor-fonts', salinger_get_font_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'salinger_block_editor_styles' );
